...
In GridTrap, the cartographer is your character navigating through the dungeon. To visualize the game state, you need to know where the cartographer is currently positioned and whether they have fallen into a trap.
...
<AutoTypeTable name="AutoType" type='export interface AutoType {
    ...
    **/
    ...
    /**
    * Comma-separated list of tile types to filter by. Allowed values are "wall", "ground", "entrance", "rope".
    **/
    type?: string;
...
- **`ground`**: Walkable areas that may have hidden traps
- **`entrance`**: The starting position where the cartographer begins
...
If you need information about a specific tile in the dungeon, you can retrieve it by its coordinates. This can be useful depending on the implementation of your play. For instance, you might want to check if the tile north of your player is ground before moving there.
