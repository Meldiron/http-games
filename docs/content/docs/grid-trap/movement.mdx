...
<Accordions type="single">
  <Accordion title="Response">
    ...
    Movement was successful. The response indicates your new position and whether you stepped on a trap.
    ...
    If you step on a trap, the response will also include `"cartographerTrapped": true`. In hardcore mode, stepping on a trap will also returns `"status": "trapped"`, ending the game.
  </Accordion>
</Accordions>
...
<Accordions type="single">
  <Accordion title="Response">
    ...
    Crawling was successful. You are now back at the entrance and no longer trapped.
...
The ultimate goal in Grid Trap is to reach the rope tile and climb it to escape the dungeon. You can only climb when your cartographer is positioned exactly on the rope tile.
...
<Accordions type="single">
  <Accordion title="Response">
    ...
    Climbing was successful. You have escaped the dungeon!
